...
passport.serializeUser((user, cb) => {
    ...
    cb(null, user); // Store entire profile if needed
});
...
passport.use(new GitHubStrategy({
        ...
        callbackURL: "http://localhost:5000/auth/github/callback" // Changed port to 5000
    },
...
app.get('/login', (req, res) => {
    if (req.isAuthenticated()) {
        return res.sendFile(path.join(__dirname, 'dashboard.html')); // Redirect to dashboard if authenticated
    }
